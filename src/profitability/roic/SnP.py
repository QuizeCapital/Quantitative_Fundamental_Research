print('Calculating data for S&P 500 ie. Market Portfolio...')
import sys
...
if __name__ == "__main__":
    ...
    path_returns = os.path.abspath(os.path.join(
        __file__, '..', '..', '..', 'data', 'S&P_historical_returns(sym_ticker,return).xlsx'))
    ...
    sandp_obj = SandP(data_df_returns, date_column, symbol, return_column, agg_function)

    cagr = sandp_obj.calculate_CAGR()
    print(cagr)